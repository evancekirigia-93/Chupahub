...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return { title, description, alternates: { canonical: `/collections/${slug}` }, openGraph: { title: `${title} | ChupaHub`, description, url: `/collections/${slug}`, type: 'website' }, twitter: { card: 'summary', title: `${title} | ChupaHub`, description }, robots: builtIn ? { index: true, follow: true } : { index: false, follow: false } };
}
