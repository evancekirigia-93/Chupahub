...
export async function POST(request: NextRequest) {
  ...
  const result = await sendEmailWithResend(config.adminEmail, 'ChupaHub Email Test Successful', '<div style="font-family:Arial,sans-serif;padding:24px"><h1 style="color:#ff4b18">ChupaHub Email Test Successful</h1><p>Your Resend order-email integration is working correctly.</p></div>');
