...
export const seoPages: Record<string, SeoPage> = {
  ...
  snacks: { title: 'Snacks Delivery Nairobi – Shop Online', heading: 'Snacks Delivery Nairobi', description: 'Shop snacks and party accompaniments online with convenient Chupa Hub delivery across Nairobi.', path: '/snacks', categorySlug: 'snacks' },
  offers: { title: 'Alcohol Offers Nairobi – Discounted Drinks', heading: 'Chupa Hub Offers', description: 'Browse currently discounted wine, beer, whisky, spirits and mixers available from Chupa Hub.', path: '/offers', offers: true },
  sameDayDelivery: { title: 'Same-Day Alcohol Delivery Nairobi', heading: 'Same-Day Drinks Delivery', description: 'Order drinks online from Chupa Hub for convenient same-day delivery in eligible Nairobi delivery areas.', path: '/same-day-delivery' },
  alcoholDeliveryNairobi: { title: 'Alcohol Delivery Nairobi – Order Drinks Online', heading: 'Alcohol Delivery Nairobi', description: 'Order wine, beer, whisky, gin, vodka, champagne and mixers online from Chupa Hub for delivery across Nairobi.', path: '/alcohol-delivery-nairobi' },
};
