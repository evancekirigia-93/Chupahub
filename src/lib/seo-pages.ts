...
export const seoPages: Record<string, SeoPage> = {
  ...
  snacks: { title: 'Snacks Delivery Nairobi – Shop Online', heading: 'Snacks Delivery Nairobi', description: 'Shop snacks and party accompaniments online with convenient ChupaHub delivery across Nairobi.', path: '/snacks', categorySlug: 'snacks' },
